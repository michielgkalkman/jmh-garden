...
/**
 *
 * @author michielgkalkman
 * @author zoly
 */
public final class JmhNewFlightRecorderProfiler implements ExternalProfiler {
    ...
    public Collection<String> addJVMOptions(final BenchmarkParams params) {
        ...
        String startFlightRecording = "duration=60s,filename=" + dumpFile;
        return Arrays.asList(
                "-XX:+FlightRecorder",
                "-XX:StartFlightRecording=" + startFlightRecording);
    }
...
//    @Override
//    public Collection<? extends Result> afterTrial(BenchmarkParams benchmarkParams, File file, File file1) {
//        NoResult r = new NoResult("Profile saved to " + dumpFile + ", results: " + benchmarkParams
//                + ", stdOutFile = " + file + ", stdErrFile = " + file1);
//        return Collections.singleton(r);
//    }

//    @Override
//    public Collection<? extends Result> afterTrial(BenchmarkParams benchmarkParams, long l, File file, File file1) {
//        NoResult r = new NoResult("Profile saved to " + dumpFile + ", results: " + benchmarkParams
//                + ", stdOutFile = " + file + ", stdErrFile = " + file1);
//        return Collections.singleton(r);
//    }
